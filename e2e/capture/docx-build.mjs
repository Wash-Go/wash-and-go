  ...
  return new Document({
    ...
    sections: [{
      ...
      children: [
        ...
        phoneRow([['customer-home.png', 'Dashboard — one-tap "Book a wash", active-order card.'], ['customer-book.png', 'Load size + pickup — GPS, saved, or geocoded address.'], ['customer-checkout.png', 'Checkout — nearest shop + distance price breakdown.']]),
        spacer(120),
